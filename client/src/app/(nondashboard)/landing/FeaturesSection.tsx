		...
		>
			<div className="max-w-4xl xl:max-w-6xl mx-auto">
				<motion.h2 variants={itemVariants} className="text-3xl font-bold text-center mb-12 w-full sm:w-2/3 mx-auto">
					Quickly find the home you want using our effective search tools!
				</motion.h2>
...
const FeatureCard = ({
	...
	<div className="text-center">
		...
		<Link href={linkHref} className="inline-block border border-gray-300 px-4 py-2 hover:bg-gray-100" scroll={false}>
			{linkText}
		</Link>
	</div>
);
